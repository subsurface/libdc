...
static dc_status_t
shearwater_common_parser_create (dc_parser_t **out, dc_context_t *context, unsigned int serial, unsigned int model, unsigned int petrel)
{
...
dc_status_t
shearwater_predator_parser_create (dc_parser_t **out, dc_context_t *context, unsigned int serial, unsigned int model)
{
	return shearwater_common_parser_create (out, context, serial, model, 0);
}


dc_status_t
shearwater_petrel_parser_create (dc_parser_t **out, dc_context_t *context, unsigned int serial, unsigned int model)
{
	return shearwater_common_parser_create (out, context, serial, model, 1);
}
